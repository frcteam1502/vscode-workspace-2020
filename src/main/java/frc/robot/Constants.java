...
public final class Constants {
    ...
    public static final class Motors {
        ...
        public static final VictorSPX INTAKE_BELT_LEFT = new VictorSPX(0);
        public static final VictorSPX INTAKE_BELT_RIGHT = new VictorSPX(5);
    ...
    public static class Sensors {
        ...
        // public static final Lidar BACK_LIDAR = new Lidar(new I2C(kOnboard, 0x62),
        // 0x62); // Do changed address first
