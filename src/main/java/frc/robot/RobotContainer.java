...
public class RobotContainer {
  ...
  // public final Lift lift = new Lift(Motors.LIFT_RIGHT, Motors.LIFT_LEFT,
  // Sensors.LIFT_UPPER_LIMIT,
  // Sensors.LIFT_LOWER_LIMIT);
  // public final LiftAdjust liftAdjust = new LiftAdjust(Motors.LIFT_ADJUSTER,
  // Sensors.LIFT_GYRO);
  ...
  private void configureButtonBindings() {
    ...
    }).andThen(new LidarStop(drivetrain, () -> Joysticks.RIGHT_JOYSTICK.getY() <= 0, () ->

    Joysticks.RIGHT_JOYSTICK.getY())));
    SmartDashboard.putNumber("Distance", Sensors.FRONT_LIDAR.getDistance());
    Joysticks.XBOX.A.toggleWhenPressed(new TestComm(go));
