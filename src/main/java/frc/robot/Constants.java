...
public final class Constants {
    ...
    public static final class Motors {
        ...
        public static final CANSparkMax DRIVE_FRONT_LEFT = new CANSparkMax(3, kBrushless);
        public static final CANSparkMax DRIVE_BACK_LEFT = new CANSparkMax(4, kBrushless);
        public static final CANSparkMax DRIVE_FRONT_RIGHT = new CANSparkMax(5, kBrushless);
        public static final CANSparkMax DRIVE_BACK_RIGHT = new CANSparkMax(6, kBrushless);
    }
