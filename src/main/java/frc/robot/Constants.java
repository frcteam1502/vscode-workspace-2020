...
public final class Constants {
  ...
  public static final class Motors {
    public static final CANSparkMax SPINNER_LIFT_MOTOR = new CANSparkMax(5, kBrushless);
    public static final CANSparkMax SPINNER_MOTOR = new CANSparkMax(6, kBrushless);
  ...
  public static class Sensors {
    ...
    public static final DigitalInput SPINNER_UPPER_LIFT_LIMIT = new DigitalInput(1);
    public static final DigitalInput SPINNER_LOWER_LIFT_LIMIT = new DigitalInput(2);
